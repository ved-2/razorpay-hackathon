...
exports.createGroqClient = createGroqClient;
exports.buildOpportunityPrompt = buildOpportunityPrompt;
exports.generateDeterministicProposal = generateDeterministicProposal;
...
function buildOpportunityPrompt(opportunity, context) {
...
function generateDeterministicProposal(opportunity, context) {
    switch (opportunity.type) {
        case "LOW_STOCK": {
            const quantity = typeof opportunity.data?.recommendedRestock === "number"
        ...
        case "CROSS_SELL": {
            const productIds = Array.isArray(opportunity.data?.productIds)
                ? opportunity.data.productIds
                : [];
            const products = Array.isArray(opportunity.data?.products)
                ? opportunity.data.products.join(" + ")
                : "Products";
            return {
                action: "BUNDLE",
